...
class NumberTest extends TestCase
{
    ...
    public function test_parse_really_small_floats()
    {
        ...
        // E-37: round to 52 decimal places
        $this->assertSame(
            '0.0000000000000000000000000000000000001234567890123456',
            Number::parse(0.000000000000000000000000000000000000123456789012345612374)
        );
    }
